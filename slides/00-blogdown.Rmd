...
Update materials from GitHub repo

Pull changes, re-download the zip, or create new project on RStudio (or cloud)...  
Does not matter how you get there just that you can! 

```{r eval=F}
https://github.com/hidyverse/RMD4HS 
```
...
```{r echo = F}
knitr::include_graphics("images/spoonful-hugo.png")
```
