...
Repo: https://github.com/hidyverse/RMD4HS 
...
**HINT**: Use `ls -a docs/` to double check your `.nojekyll` file was made or turn on `show hidden files` within `more` in the `files` browser in RStudio  
